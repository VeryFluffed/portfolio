...
const Introduction = () => {
    return (
        <section className="w-full bg-white">
            ...
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-stretch gap-12 mb-16 mt-14">
                ...
                <div className="flex-1 p-8 bg-white flex flex-col justify-center">
                    ...
                    <p className="text-xl about_tag text-gray-700 leading-relaxed text-justify mt-4">

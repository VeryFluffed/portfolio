    ...
    <section className="bg-background relative flex min-h-screen w-full flex-col">
      ...
      >
        <div className="flex flex-col items-center justify-center gap-2 px-4">
          <p className="font-timesnewroman text-foreground text-center text-6xl font-light">
            DANH CHI TRAN
          </p>
          <p className="font-timesnewroman text-foreground text-center text-2xl font-thin">
